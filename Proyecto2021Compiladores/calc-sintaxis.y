...
bool_literal: TRUE                              {   info *infS = (info *)malloc(sizeof(info));
                                                    ...
                                                    infS->type = boolean;
                                                    infS->line = yylineno;
                                                    $$ = create_bNode(LITERAL1, infS, NULL, NULL, NULL); }
